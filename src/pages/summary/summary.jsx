    ...
    return (
        <>
            ...
            <div className='justify-self-center my-0 mx-auto h-auto py-8'>
                ...
                <div>
                    <div className='w-full h-auto bg-[#d6d9d6] rounded-lg p-4 mt-8'>
                        <div className='flex justify-between items-center mb-2'>
                            <div>
                                <h1 className='text-[#02295a] font-bold'>Arcade (Monthly)</h1>
                                <p className='underline text-[#473dff] cursor-pointer' onClick={() =>{navigate('/selectPlan')}}>Change</p>
                            </div>
                            <div>
                                <h1 className='text-[#02295a] font-bold'> $9/mo</h1>
                            </div>
                        </div>
