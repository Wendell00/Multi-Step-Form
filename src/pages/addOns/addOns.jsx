                ...
                <div>
                    <ul className='w-[455px]'>
                        <li className='flex justify-between mt-2 w-full items-center border-[1px] border-solid border-[#473dff] rounded-lg p-2'>
                            <input type="checkbox" className='addCheck bg-[#473dff] justify-self-center ml-[15px]'/>
                            ...
                            <div className='font-thing text-[#473dff] text-sm mr-[15px]'>+${!periodPlan ? '1/mo' : '10/yr'}</div>
                        </li>
                        <li className='flex mt-2 justify-between w-full items-center border-[1px] border-solid border-[#473dff] rounded-lg p-2'>
                            ...
                            <div className='font-thing text-[#473dff] text-sm mr-[15px]'>+${!periodPlan ? '2/mo' : '20/yr'}</div>
                        </li>
                        <li className='flex mt-2 justify-between w-full items-center border-[1px] border-solid border-[#473dff] rounded-lg p-2'>
                            <input type="checkbox" className='addCheck checked:bg-[#473dff] justify-self-center ml-[15px]'/>
